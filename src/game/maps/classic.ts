...
const spaces = [
  ...
  makeProperty(3, "Kiln Street", "brown", 60),
  makeChoiceTax(4, "Income Tax", 200, 10),
  makeTransport(5, "Central Station", 200),
  makeProperty(6, "Foundry Lane", "lightblue", 100),
  makeCard(7, "Surprise", "surprise"),
  makeProperty(8, "Millwright Avenue", "lightblue", 100),
  makeProperty(9, "Cooper's Yard", "lightblue", 120),
  { index: 10, name: "Jail", type: "jail" as const },
  makeProperty(11, "Weaver's Row", "pink", 140),
  makeUtility(12, "Municipal Power", 150),
  makeProperty(13, "Ropewalk Street", "pink", 140),
  makeProperty(14, "Cobble Court", "pink", 160),
  makeTransport(15, "Union Depot", 200),
  makeProperty(16, "Regent Crescent", "orange", 180),
  makeCard(17, "Treasure", "treasure"),
  makeProperty(18, "Sovereign Street", "orange", 180),
  makeProperty(19, "Monarch Row", "orange", 200),
  { index: 20, name: "Free Parking", type: "free" as const },
  makeProperty(21, "Harbour Walk", "red", 220),
  makeCard(22, "Surprise", "surprise"),
  makeProperty(23, "Wharfside Avenue", "red", 220),
  makeProperty(24, "Anchor Street", "red", 240),
  makeTransport(25, "Junction Yard", 200),
  makeProperty(26, "Crown Terrace", "yellow", 260),
  makeProperty(27, "Sceptre Street", "yellow", 260),
  makeUtility(28, "Civic Waterworks", 150),
  makeProperty(29, "Jubilee Court", "yellow", 280),
  { index: 30, name: "Go To Jail", type: "gotojail" as const },
  makeProperty(31, "Meridian Avenue", "green", 300),
  makeProperty(32, "Compass Street", "green", 300),
  makeCard(33, "Treasure", "treasure"),
  makeProperty(34, "Lighthouse Row", "green", 320),
  makeTransport(35, "Terminal Line", 200),
  makeCard(36, "Surprise", "surprise"),
  makeProperty(37, "Grand Terrace", "darkblue", 350),
  makeTax(38, "Luxury Tax", 100),
  makeProperty(39, "Summit Crescent", "darkblue", 400),
];
