...
const spaces = [
  ...
  makeProperty(1, "Tannery Row", "brown", 60),
  makeCard(2, "Treasure", "treasure"),
  makeProperty(3, "Foundry Lane", "brown", 60),
  makeChoiceTax(4, "Property Assessment", 200, 10),
  makeTransport(5, "Northern Line Depot", 200),
  makeProperty(6, "Kiln Street", "lightblue", 100),
  makeCard(7, "Surprise", "surprise"),
  makeProperty(8, "Cooper's Yard", "lightblue", 100),
  makeProperty(9, "Millrace Way", "lightblue", 120),
  { index: 10, name: "Jail", type: "jail" as const },
  makeProperty(11, "Bellweather Avenue", "pink", 140),
  makeUtility(12, "Municipal Power", 150),
  makeProperty(13, "Quarry Road", "pink", 140),
  makeProperty(14, "Saltmarket", "pink", 160),
  makeTransport(15, "Eastgate Station", 200),
  makeProperty(16, "Candlewick Street", "orange", 180),
  makeCard(17, "Treasure", "treasure"),
  makeProperty(18, "Drapers Gate", "orange", 180),
  makeProperty(19, "Ironmonger Row", "orange", 200),
  { index: 20, name: "Free Parking", type: "free" as const },
  makeProperty(21, "Harbour Walk", "red", 220),
  makeCard(22, "Surprise", "surprise"),
  makeProperty(23, "Custom House Quay", "red", 220),
  makeProperty(24, "Exchange Place", "red", 240),
  makeTransport(25, "Harbour Terminus", 200),
  makeProperty(26, "Bishopsgate Rise", "yellow", 260),
  makeProperty(27, "Corn Exchange", "yellow", 260),
  makeUtility(28, "Municipal Waterworks", 150),
  makeProperty(29, "Regent Crescent", "yellow", 280),
  { index: 30, name: "Go To Jail", type: "gotojail" as const },
  makeProperty(31, "Amberley Square", "green", 300),
  makeProperty(32, "Wexford Terrace", "green", 300),
  makeCard(33, "Treasure", "treasure"),
  makeProperty(34, "Kingsmere Row", "green", 320),
  makeTransport(35, "Central Junction", 200),
  makeCard(36, "Surprise", "surprise"),
  makeProperty(37, "Crown Terrace", "darkblue", 350),
  makeTax(38, "Excise Duty", 100),
  makeProperty(39, "Aldwych Park", "darkblue", 400),
];
